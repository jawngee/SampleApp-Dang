...
+ (void)customizeNavigationController:(UINavigationController *)navController
{
    ...
    {
        [navBar setBackgroundImage:[UIImage imageNamed:@"topbar-background-image.png"] forBarMetrics:UIBarMetricsDefault];
    }
    else
    {
        ...
        if (imageView == nil)
        {
            imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"topbar-background-image.png"]];
