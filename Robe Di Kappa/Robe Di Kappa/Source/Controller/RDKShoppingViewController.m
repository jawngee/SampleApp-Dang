...
@implementation RDKShoppingViewController
...
- (void)viewDidLoad
{
    ...
    /** create scroll view */
    UIImage *image_1 = [UIImage imageNamed:@"shopping-image-1.png"];
    UIImage *image_2 = [UIImage imageNamed:@"shopping-image-2.png"];	
	UIImage *image_3 = [UIImage imageNamed:@"shopping-image-3.png"];	
    UIImage *image_4 = [UIImage imageNamed:@"shopping-image-4.png"];
    
    NSArray *imageArray = [[NSArray alloc] initWithObjects:image_1, image_2, image_3, image_4, nil];
